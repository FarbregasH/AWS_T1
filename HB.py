...
token_data_path = r"/home/ec2-user/AWS_T1/Token_Master_HB.csv"  # Update this path to your EC2 instance path
...
osmosis_addresses = [
    ("HUOBI", "osmo1nt0x24phhajhknheh5n4rsy0ykg8ejrjqwgcfm"),
]
