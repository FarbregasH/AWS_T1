...
token_data_path = r"/home/ec2-user/AWS_T1/Token_Master_CEX2_KC.csv"  # Update this path to your EC2 instance path
...
osmosis_addresses = [
    ("CEX2_KC", "osmo152fwqsla5lxfu3sgy65naf7w2up0za8fd54ght"),
]
